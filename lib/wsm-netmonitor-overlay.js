...
// Constants
const NETWORK_STYLES_URL = "chrome://websocketmonitor/skin/netmonitor.css";
 ...
 */
const WsmNetMonitorOverlay = Class(
/** @lends WsmNetMonitorOverlay */
{
  extends: PanelOverlay,

  overlayId: "webSocketsWsmNetMonitorOverlay",
  panelId: "netmonitor",
  ...
  onReady: function(options) {
    ...
    Trace.sysout("WsmNetMonitorOverlay.onReady;", options);
  },
  ...
  onNavigate: function(requestId) {
    this.toolbox.selectTool(WS_PANEL_ID).then(tool => {
...
exports.WsmNetMonitorOverlay = WsmNetMonitorOverlay;
